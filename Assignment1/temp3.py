...
from temp import Word2VecModel, Word2VecDataset
import numpy as np
...
dataset = NeuralLMDataset("./corpus.txt",13000, context_size=3)
...
model = NeuralLM1(13000,100, hidden_dim,3, dataset.embeddings)
...
model_2 = NeuralLM2(13000,100,hidden_dim, 3, dataset.embeddings)
...
model_3 = NeuralLM3(13000,100, hidden_dim, 3, dataset.embeddings)
